...
export class TransformedImage {
     ...
     */
    constructor(public fileName: string, public filePath: string, public thumbnailPath: string, public isSelected: boolean, public date: string, public displayStyle: string) { }
}
